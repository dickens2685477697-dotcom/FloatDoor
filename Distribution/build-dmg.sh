...
ICON_SOURCE="$PROJECT_DIR/Sources/FloatDoor/Resources/Icons/app-icon-master.png"
...
cp "$PROJECT_DIR/Distribution/PUBLIC_LICENSE.md" "$STAGE_DIR/LICENSE.md"
cp "$PROJECT_DIR/Distribution/PUBLIC_NOTICE.md" "$STAGE_DIR/NOTICE.md"
